 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="uploadForm" method="post" action="${APP_PATH}/member/uploadcerts" enctype="multipart/form-data" role="form" style="margin-top:20px;">
		    ...
		    <#list certs as cert>
				  <div class="form-group">
		            ...
		            <img src="${APP_PATH}/ztree/img/loading.gif" style="display:none;">
				  </div>
		    </#list>
        ...
        function next() {
		    ...
		    $("#uploadForm").ajaxSubmit({
		        ...
		        success : function(result) {
		             if ( result.success ) {
			        	layer.msg("资质文件上传成功。", {time:2000, icon:6}, function(){
			        	     // 执行下一步
